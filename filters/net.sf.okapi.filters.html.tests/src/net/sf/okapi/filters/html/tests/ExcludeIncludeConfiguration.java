...
import net.sf.okapi.filters.html.AttributeExtractionRule;
import net.sf.okapi.filters.html.ConditionalAttributeRule;
import net.sf.okapi.filters.html.ExtractionRule;
import net.sf.okapi.filters.html.IHtmlFilterConfiguration;

public class ExcludeIncludeConfiguration implements IHtmlFilterConfiguration {
	...
	public ExcludeIncludeConfiguration() {
	...
	public void initializeDefaultRules() {
		...
		// test exclude - include rules
		ruleMap.put("exclude", ExtractionRule.createExcludedRule("exclude"));
		ruleMap.put("include", ExtractionRule.createIncludedRule("include"));
