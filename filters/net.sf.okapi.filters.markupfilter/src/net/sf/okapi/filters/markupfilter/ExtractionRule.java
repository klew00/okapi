...
public class ExtractionRule {
	...
	public static enum EXTRACTION_RULE_TYPE {
		NON_EXTRACTABLE, EXTRACTABLE_ATTRIBUTES, EXTRACTABLE_ATTRIBUTE_ANY_ELEMENT, INLINE_ELEMENT, EXCLUDED_ELEMENT, INCLUDED_ELEMENT, GROUP_ELEMENT, TEXT_UNIT_ELEMENT, TEXT_RUN_ELEMENT, PRESERVE_WHITESPACE
	};
