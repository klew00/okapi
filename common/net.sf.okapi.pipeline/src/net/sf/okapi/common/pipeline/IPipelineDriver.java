...
public interface IPipelineDriver {
	 ...
	 * @param pipeline the new {@link IPipeline} to associate with this driver.
	 */
	...
	/**
	 * Indicates if any of the current steps in this driver needs output information.
	...
	/**
	 * Sets a new set of batch items for this driver and processes them. Any batch
	 * item that was already in the driver is removed and replaced by the ones
	 * provided to this method. 
	 * @param batchItems the list of the batch items to process.
	 */
	 ...
	 * @param item the item to add to this batch.
	 */
	 ...
	 * @param filterConfigId the filter configuration ID of the document
