...
mvn install:install-file -DgroupId=org.json -DartifactId=json-simple -Dversion=1.1 -Dfile=third-party/json-simple/json-simple-1.1.jar -Dpackaging=jar -DgeneratePom=true
