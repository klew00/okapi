...
mvn install:install-file -DgroupId=net.htmlparser.jericho -DartifactId=jericho-html -Dversion=3.1 -Dfile=third-party/jericho-html-3.1.jar -Dpackaging=jar -DgeneratePom=true
