...
public class ObjectFactory {
    ...
    private final static QName _GetLanguageNamesAppId_QNAME = new QName("http://api.microsofttranslator.com/v1/soap.svc", "appId");
    ...
    public JAXBElement<String> createGetLanguageNamesAppId(String value) {
        return new JAXBElement<String>(_GetLanguageNamesAppId_QNAME, String.class, GetLanguageNames.class, value);
    }
    ...
    public JAXBElement<String> createGetLanguagesAppId(String value) {
        return new JAXBElement<String>(_GetLanguageNamesAppId_QNAME, String.class, GetLanguages.class, value);
    }
    ...
    public JAXBElement<String> createTranslateAppId(String value) {
        return new JAXBElement<String>(_GetLanguageNamesAppId_QNAME, String.class, Translate.class, value);
    }
    ...
    public JAXBElement<String> createDetectAppId(String value) {
        return new JAXBElement<String>(_GetLanguageNamesAppId_QNAME, String.class, Detect.class, value);
    }
