...
public class ParagraphGaleAndChurch implements AlignmentScorer<ITextUnit> {
	private static final Logger LOGGER = Logger.getLogger(ParagraphGaleAndChurch.class.getName());
	 ...
	 */
	public int meldingScore(ITextUnit p_sourceTuv1, ITextUnit p_sourceTuv2, ITextUnit p_targetTuv1,
			ITextUnit p_targetTuv2) {
		// TODO: remove codes to get length
		int sourceLength1 = p_sourceTuv1.toString().length();
		int sourceLength2 = p_sourceTuv2.toString().length();
		int targetLength1 = p_targetTuv1.toString().length();
