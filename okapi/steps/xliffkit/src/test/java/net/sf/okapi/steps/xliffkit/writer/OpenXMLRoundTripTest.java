...
import net.sf.okapi.filters.openxml.CodePeekTranslator;
import net.sf.okapi.filters.openxml.ConditionalParameters;
import net.sf.okapi.filters.openxml.OpenXMLFilter;
import net.sf.okapi.filters.openxml.OpenXMLZipFilterWriter;
import net.sf.okapi.filters.openxml.PigLatinTranslator;
import net.sf.okapi.filters.openxml.TagPeekTranslator;
import net.sf.okapi.filters.openxml.ZipCompare;
...
//			filter.setLogLevel(Level.FINE);
			...
			sInputPath = src1Path;
			sOutputPath = pathBase;
			
//			sInputPath = TestUtil.getParentDir(this.getClass(), "/src1/BoldWorld.docx");
