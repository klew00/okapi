...
import net.sf.okapi.persistence.beans.v0.DocumentBean;
import net.sf.okapi.persistence.beans.v0.DocumentPartBean;
import net.sf.okapi.persistence.beans.v0.EndingBean;
import net.sf.okapi.persistence.beans.v0.EventBean;
import net.sf.okapi.persistence.beans.v0.FilterWriterBean;
import net.sf.okapi.persistence.beans.v0.GenericSkeletonBean;
import net.sf.okapi.persistence.beans.v0.GenericSkeletonPartBean;
import net.sf.okapi.persistence.beans.v0.InlineAnnotationBean;
import net.sf.okapi.persistence.beans.v0.MultiEventBean;
import net.sf.okapi.persistence.beans.v0.ParametersBean;
import net.sf.okapi.persistence.beans.v0.PropertyBean;
import net.sf.okapi.persistence.beans.v0.RawDocumentBean;
import net.sf.okapi.persistence.beans.v0.SegmentBean;
import net.sf.okapi.persistence.beans.v0.StartDocumentBean;
import net.sf.okapi.persistence.beans.v0.StartGroupBean;
import net.sf.okapi.persistence.beans.v0.StartSubDocumentBean;
import net.sf.okapi.persistence.beans.v0.TargetPropertiesAnnotationBean;
import net.sf.okapi.persistence.beans.v0.TextContainerBean;
import net.sf.okapi.persistence.beans.v0.TextFragmentBean;
